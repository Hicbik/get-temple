...
const COOKIES = 'SameSite=None; SameSite.sig=vM6MaQ_p2VuipSq0vWf6qV23bmWTYDJwEFhXwyj01HY; MANAGE_SESS=bc2fe6d33e625206c1cf6e8acef869d3; MANAGE_SESS.sig=YmQBiLfqI7TXYi023PPPiTkuu0jlIJ9UQlQHKvlcgSs';
...
export const updateTempleImages = async (xlsxPath, province, city) => {
  ...
  for (const templeItem of list) {
    ...
    const imageFilePath = `../../../1/${find.province}/${find.city}/${find.area}/${find.placeName}`;
...
export const getCrmTempleList = async (province, city, param?: any) => {
